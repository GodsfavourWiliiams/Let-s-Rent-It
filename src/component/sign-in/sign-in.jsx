        ...
        <div className="min-h-screen flex flex-col items-center justify-center w-full py-16 px-3">
               <Link to="/">
                ...
                <div className=" lg:w-1/3 md:w-1/2 w-full my-8 text-center">
                    ...
                    <button aria-label="Continue with github" className="focus:outline-none  focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 py-3.5 px-4 border rounded-5 border-gray-700 flex items-center w-full mt-4">
                    ...
                    <button aria-label="Continue with twitter" className="focus:outline-none  focus:ring-2 focus:ring-offset-1 focus:ring-gray-700 py-3.5 px-4 border rounded-5 border-gray-700 flex items-center w-full mt-4">
                ...
                <form onClick={this.handleSubmit}>
                   ...
                   <Button className="bg-primary-100 mt-6 rounded-5 text-white" >Sign In</Button>
                </form>
            </div>
        </div>

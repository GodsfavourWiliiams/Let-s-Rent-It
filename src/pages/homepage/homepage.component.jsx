              ...
              >
                <Dialog.Panel className="relative bg-white rounded-lg text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:max-w-3xl sm:w-full">
                  <div className="sm:flex sm:items-start">
                      <div className="relative text-center sm:text-left flex flex-col items-center bg-white border rounded shadow-sm lg:flex-row">
                        <div className="w-full p-6 py-8 sm:p-12 lg:w-1/2">
                            ...
                            <div className="lg:flex w-full hidden lg:w-1/2">
                                ...
                                <div className="w-full bg-gray-300 lg:py-0 lg:rounded-r sm:pl-2 xl:pl-0">
                                    <div className="w-full h-full transform lg:mt-20 lg:scale-110 xl:scale-135 gatsby-image-wrapper" >

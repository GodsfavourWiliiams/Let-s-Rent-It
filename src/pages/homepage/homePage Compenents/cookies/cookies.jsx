...
const cookies = () => {
  return (
    <div>   <section data-section-id="2" data-category="product-info" data-component-id="b9652106_01_awz" class="py-20">
      ...
      <div class="flex flex-wrap -mx-4 mb-24">
        <div class="w-full md:w-1/2 px-4 mb-8 md:mb-0">
          <div class="relative mb-10" style={{height: "564px"}}>
            ...
            <img class="object-cover w-full h-full" src="yofte-assets/images/product-bottle.png" alt="" data-config-id="auto-img-1"/>
          ...
          <div class="flex flex-wrap -mx-2">
            <div class="w-1/2 sm:w-1/4 p-2">
              <a class="block border border-blue-300" href="/">
                <img class="w-full h-32 object-cover" src="yofte-assets/images/product-bottle.png" alt="" data-config-id="image1"/>
              </a>
            </div>
            <div class="w-1/2 sm:w-1/4 p-2">
              <a class="block border border-transparent hover:border-gray-400" href="/">
                <img class="w-full h-32 object-cover" src="yofte-assets/images/product-bottle2.png" alt="" data-config-id="image2"/>
              </a>
            </div>
            <div class="w-1/2 sm:w-1/4 p-2">
              <a class="block border border-transparent hover:border-gray-400" href="/">
                <img class="w-full h-32 object-cover" src="yofte-assets/images/product-bottle3.png" alt="" data-config-id="image3"/>
              </a>
            </div>
            <div class="w-1/2 sm:w-1/4 p-2">
              <a class="block border border-transparent hover:border-gray-400" href="/">
                <img class="w-full h-32 object-cover" src="yofte-assets/images/product-bottle4.png" alt="" data-config-id="image4"/>
              </a>
            </div>
          </div>
        </div>
        <div class="w-full md:w-1/2 px-4">
          <div class="lg:pl-20">
            <div class="mb-10 pb-10 border-b">
              <span class="text-gray-500" data-config-id="label">Brille</span>
              <h2 class="mt-2 mb-6 max-w-xl text-5xl md:text-6xl font-bold font-heading" data-config-id="title">BRILE water filter carafe</h2>
              <div class="mb-8">
                <button>
              ...
              <p class="inline-block mb-8 text-2xl font-bold font-heading text-blue-300">
                ...
                <span class="font-normal text-base text-gray-400 line-through" data-config-id="price-old">$33.69</span>
              </p>
              <p class="max-w-md text-gray-500" data-config-id="desc">Maecenas commodo libero ut molestie dictum. Morbi placerat eros id porttitor sagittis.</p>
            </div>
            <div class="flex mb-12">
              <div class="mr-6">
                <span class="block mb-4 font-bold font-heading text-gray-400 uppercase" data-config-id="label1">QTY</span>
              ...
              <div>
                <span class="block mb-4 font-bold font-heading text-gray-400 uppercase" data-config-id="label2">Size</span>
            ...
            <div class="flex flex-wrap -mx-4 mb-14 items-center">
              <div class="w-full xl:w-2/3 px-4 mb-4 xl:mb-0"><a class="block bg-orange-300 hover:bg-orange-400 text-center text-white font-bold font-heading py-5 px-8 rounded-md uppercase transition duration-200" href="/" data-config-id="primary-action">Add to cart</a></div>
            ...
            <div class="flex items-center">
              <span class="mr-8 text-gray-500 font-bold font-heading uppercase" data-config-id="share">SHARE IT</span>

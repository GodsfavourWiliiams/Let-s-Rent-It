...
const SignIn = () => {
  ...
  return (
    ...
    <Link to="/">
     ...
     <div className=" lg:w-1/3 md:w-1/2 w-full my-3 text-center">
         ...
         <button aria-label="Continue with google" className="focus:outline-none form__input py-3 px-4 border rounded-lg border-gray-300 flex items-center w-full mt-6" 
         onClick={signInWithGoogle}>
             <svg width={18} height={18} viewBox="0 0 19 20" fill="none">
             ...
             <p className="sm:text-base text-sm font-medium ml-4 text-gray-700">Continue with Google</p>
         </button>
     ...
     <form onSubmit={logIn}>
         ...
         required/>
            ...
            <div className="relative float-right -mt-8 z-30 mr-4 cursor-pointer" 
        ...
        <Button className={`${isButtonLoading ? "py-0" : "py-3"} bg-primary-100 w-full mt-6 mb-2 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-800`}>
            {isButtonLoading ?
            <PreLoader/> :
            "Sign In"
            }

               ...
               <Link to="/">
                ...
                <FormInput 
                    ...
                    required/>
                        ...
                        <div className="relative float-right cursor-pointer -mt-8 mr-4 z-30 "
                   ...
                   <Button className="bg-primary-100 mt-6 w-full py-3 rounded-lg text-white focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-green-800" 
                  >Sign Up</Button>
                </form>
            </div>
        </div>
